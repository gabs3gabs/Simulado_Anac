...
public class QuestoesTecActivity extends AppCompatActivity {
        ...
        setContentView(R.layout.activity_questoes_tec);
        ...
        btnProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (posicao == list.size()){
                    Intent pontosInt = new Intent(QuestoesTecActivity.this, PontuacaoActivity.class);
