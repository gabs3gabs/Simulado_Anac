...
public class QuestoesTeoActivity extends AppCompatActivity {
        ...
        setContentView(R.layout.activity_questoes_teo);
        ...
        btnProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (posicao == list.size()){
                    Intent pontosInt = new Intent(QuestoesTeoActivity.this, PontuacaoActivity.class);
