...
public class QuestoesRegActivity extends AppCompatActivity {
        ...
        setContentView(R.layout.activity_questoes_reg);
        ...
        btnProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (posicao == list.size()){
                    Intent pontosInt = new Intent(QuestoesRegActivity.this, PontuacaoActivity.class);
